          ...
          <div className='col-lg-6'>
            <div className='work7-image-area image-anime'>
              ...
              <div className='heading7'>
                ...
                <div className='space20'></div>
                <div className=''>
                  <Link className='theme-btn13' href={leftContent.btnUrl}>
                    <span className='text'>{leftContent.btnName}</span>{' '}
          ...
          <div className='col-lg-6'>
            <div className='heading7'>
              <SectionTitle3
                ...
                content='Explore our diverse portfolio of successful projects and client engagements. From implementing robust cybersecurity solutions to developing cutting-edge software applications and optimizing network infrastructure'></SectionTitle3>
