            ...
            <div className='sidebar-box-area sidebar-bg mb-40'>
              ...
              <div className='sidebar-blog-boxs'>
                <div className='sidebar-blogs'>
                  <div className=''>
                    <div className='image'>
                      <img src='/assets/img/blog-details-sidebar1.png' alt='' />
                    </div>
                  </div>
                  <div className='heading'>
                    <a href='#' className='date'>
                      <img src='/client/icons/date.png' alt='' /> 19/02/2024
                    </a>
                    <h5>
                ...
                <div className='sidebar-blogs'>
                  <div className=''>
                    <div className='image'>
                      <img src='/assets/img/blog-details-sidebar2.png' alt='' />
                    </div>
                  </div>
                  <div className='heading'>
                    <a href='#' className='date'>
                ...
                <div className='sidebar-blogs'>
                  <div className=''>
                    <div className='image'>
                      <img src='/assets/img/blog-details-sidebar3.png' alt='' />
                    </div>
                  </div>
                  <div className='heading'>
                    <a href='#' className='date'>
                ...
                <div className='sidebar-blogs'>
                  ...
                  <div className='heading'>
                    ...
                    <h5>
                      <Link href='/blog/blog-details'>
                        One of the primary objectives of cybersecurity is to protect{' '}
                      </Link>
                    </h5>
                  </div>
                </div>
                  ...
                  <div className='heading1'>
                    ...
                    <div className='comment-box'>
                      <div className='box-top-area'>
                        <div className='heading-area'>
                          <div className='image'>
                            <img src='/assets/img/comment-box-image1.png' alt='' />
                          </div>
                          <div className='heading'>
                            <h5>
                      ...
                      <div className='space20'></div>
                      <p className='pera'>
                        The team at {APP_NAME} goes above and beyond to provide exceptional support
                        and service. From the initial consultation to the final deployment, they
                        were there every step of the way, ensuring a seamless integration of our new
                        technology solution.
                      </p>
                    </div>
                    ...
                    <div className='comment-box comment-box2'>
                      <div className='box-top-area'>
                        <div className='heading-area'>
                          <div className='image'>
                            <img src='/assets/img/comment-box-image2.png' alt='' />
                          </div>
                          <div className='heading'>
                            <h5>
                      ...
                      <div className='space20'></div>
                      <p className='pera'>
                        We approached {APP_NAME} with a complex IT problem, and they were able to
                        provide an innovative solution that addressed our needs perfectly. Their
                        teams creativity, technical prowess, and dedication to client satisfaction
