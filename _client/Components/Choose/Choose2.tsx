          ...
          <div className='col-lg-6'>
            <div className='heading2'>
              <span className='span' data-aos='zoom-in-left' data-aos-duration='700'>
                <img src='/client/icons/span2.png' alt='' /> Best It Solution
              </span>
              ...
              <p data-aos='fade-right' data-aos-duration='700'>
                At {APP_NAME}, we understand that every business is unique, which is why we offer a
                range of flexible IT solutions designed to address your specific challenges and
                goals.
              </p>
              ...
              <div className='item-box' data-aos='fade-right' data-aos-duration='900'>
                <div className='icon'>
                  <div className=''>
                    <img src='/client/icons/solution-iocn1.png' alt='' />
                  </div>
                </div>
                <div className=''>
                  <h3>
              ...
              <div className='item-box' data-aos='fade-right' data-aos-duration='1100'>
                <div className='icon'>
                  <div className=''>
                    <img src='/client/icons/solution-iocn2.png' alt='' />
                  </div>
                </div>
                <div className=''>
                  <h3>
