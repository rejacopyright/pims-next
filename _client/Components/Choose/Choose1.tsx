...
const Choose1 = () => {
  const mainContent = {
    ...
    Content: `At ${APP_NAME}, we understand that every business is unique, which is why we offer a range of flexible IT solutions designed to address your specific challenges and goals.`,
          ...
          <div className='col-lg-6'>
            <div className='heading1'>
              <span className='span' data-aos='zoom-in-left' data-aos-duration='700'>
                <img src='/client/icons/span1.png' alt='' />
