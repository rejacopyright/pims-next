...
const Testimonial3 = () => {
  ...
  return (
    <div
      className='testimonial4 testimonial-2 position-relative bg6 section-padding'
      data-background='/assets/img/bg/testimonial4-bg.png'>
          ...
          <div className='col-md-7 m-auto text-center'>
            <div className='heading4-w'>
              <SectionTitle2
                ...
                Title='See What Our Customer Saying'></SectionTitle2>
            </div>
          </div>
        </div>
