...
const Faq2 = () => {
  ...
  return (
    <div className='faq7 sp bg-white'>
        ...
        <div className='row align-items-center'>
          <div className='col-lg-6'>
            <div className='heading7'>
              <SectionTitle3
                ...
                content='Got questions? We have got answers. Explore our frequently asked questions to learn more about our IT solutions and how they can benefit your business.'></SectionTitle3>
          ...
          <div className='col-lg-6'>
            <div className='faq-image image-anime' data-aos='zoom-out' data-aos-duration='800'>
              <img src='/client/img/hero7-image.png' alt='' />
            </div>
          </div>
        </div>
      </div>
