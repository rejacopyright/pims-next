          ...
          <div className='col-lg-6'>
            <div className='heading3'>
              ...
              <p data-aos='fade-right' data-aos-duration='700'>
                Our journey began with a simple vision: to revolutionize how businesses and
                individuals interact with technology. Today, we stand proud as a leading force in
                the industry, driven by innovation, integrity, and a commitment to excellence.
              </p>
              <div className='row'>
                <div className='col-lg-6'>
                  <div className='about3-box' data-aos='fade-right' data-aos-duration='900'>
                    ...
                    <p>
                      Established in 1975, {APP_NAME} was born out of a passion for pushing the
                ...
                <div className='col-lg-6'>
                  <div className='about3-box' data-aos='fade-right' data-aos-duration='700'>
                    ...
                    <div className='space10'></div>
                    <p>
                      Our mission is clear: to empower organizations and individuals with
              ...
              <div className='cs_case_study_1_list'>
                <div className='cs_case_study cs_style_1 cs_hover_active'>
                  <div
                    ...
                    data-src='/assets/img/about/about1-img1.png'></div>
                </div>
                <div className='cs_case_study cs_style_1 cs_hover_active'>
                  <div
