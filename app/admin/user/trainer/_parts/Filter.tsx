            ...
            <div className='d-flex flex-wrap align-items-center gap-12px col'>
              ...
              <div className='col-auto'>
                <Dropdown>
                  <Dropdown.Toggle
                    ...
                    <div className='fw-bolder lh-1 text-nowrap text-dark'>Import Trainer</div>
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                    <Dropdown.Item onClick={onClickImport}>
                      <div className='d-flex align-items-center gap-10px py-5px'>
                        ...
                        <div className='fw-bold lh-1 text-nowrap text-dark'>Import Trainer</div>
                      </div>
                    </Dropdown.Item>
                    <Dropdown.Item
                      onClick={() =>
                        exportToExcel({
                          fileName: `${moment().format('[TRAINER-TEMPLATE]_yyyy-MM-DD_HH:mm:ss')}`,
                          data: [
                            {
                              first_name: null,
                              last_name: null,
              ...
              <div className='col-auto'>
                <div
                  ...
                  <div className='fw-bolder lh-1 text-nowrap text-dark'>Tambah Trainer</div>
                </div>
              </div>
            </div>
          </div>
