import { changeUserToRegular } from '@api/users'
        ...
        <div className=''>
          <div className='p-15px d-flex flex-center h-100px'>
            <div className='text-center fs-14px'>
              <span className=''>Apakah anda yakin ingin mengubah</span>
              <span className='fw-bolder mx-5px'>{detail?.full_name || 'Member'}</span>
              <span className=''>menjadi user reguler ?</span>
            </div>
          </div>
          <div className='border-top border-2 p-15px d-flex align-items-center justify-content-end gap-10px'>
            ...
            <button
              ...
              {btnLoading ? (
                ...
                <>
                  <i className='fas fa-exchange-alt p-0 text-white fs-14px mb-1px' />
                  <div className='fs-14px me-5px'>Pindahkan</div>
                </>
              )}
            </button>
          </div>
